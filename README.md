...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-0x-project-react-context-hooks-starwars-datatable-filters.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `sd-0x-project-react-context-hooks-starwars-datatable-filters`
